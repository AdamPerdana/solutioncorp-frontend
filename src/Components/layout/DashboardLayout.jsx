...
export default function DashboardLayout({ onLogout }) {
  ...
  return (
    <div className="min-h-screen bg-[#15171c] flex text-gray-300 relative overflow-x-hidden">
      {sidebarOpen && (
        <div
      ...
      <div className="flex-1 flex flex-col min-w-0 w-full">
        <div className="md:hidden bg-[#1a1c23] border-b border-gray-800 px-4 py-3 flex items-center justify-between sticky top-0 z-30">
          <button
